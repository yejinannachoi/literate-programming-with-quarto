...
plt.ylabel("Country")
plt.title("10 Countries with Lowest Measles Immunisation Rate (2022)")
plt.xlim(0, 100)
plt.show()
```
...
As seen in @tbl-ttest-results, the T-test results confirm that GDP per capita, literacy rate, and measles immunization rate are all significantly associated with life expectancy.
